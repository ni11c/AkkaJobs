...
namespace Agridea
{
    public partial interface IAgrideaService
    {
        ...
        void SqlBulkCopy(IEnumerable<NewsItem> items);
    	void SqlBulkCopyWithId(IEnumerable<NewsItem> items);
        void SqlInsert(IEnumerable<NewsItem> items);
        void SqlUpdate(IEnumerable<NewsItem> items);
        #endregion
        
        #region CascadeRemove
        void CascadeRemove(NewsItem item); 
        void CascadeRemoveRange(IList<NewsItem> items); 
        #endregion
    }
}
