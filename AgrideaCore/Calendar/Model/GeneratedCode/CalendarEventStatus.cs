...
namespace Agridea.Calendar
{
    [Reference]
    [Serializable]
    public partial class CalendarEventStatus : PocoBase, IEquatable<CalendarEventStatus>
    {
        ...
        public void CopyTo(CalendarEventStatus other)
        {
            other.Code = Code;
        ...
        {
            return Equals(other as CalendarEventStatus);
        }
